...
public class DriveTele implements ILoopable {
    ...
    double rightThrottle = _joystick.getRawAxis(5)*-1;
    double leftThrottle = _joystick.getRawAxis(1)*-1;
    _drive.driveDirect(leftThrottle, rightThrottle);
    ...
    final double DRIVE_K = 0.60; // How hard to drive fwd toward the target
